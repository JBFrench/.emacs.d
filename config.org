...
(add-hook 'rust-mode-hook 
    '(lambda () 
#+end_src
*** DONE Setting up Racer
#+begin_src emacs-lisp :tangle yes
     (require 'racer)
     (require 'company)

     (setq racer-cmd "~/.cargo/bin/racer") ;; Rustup binaries PATH      
     (setq racer-rust-src-path "/Users/jbfrench/rust/rust-lang/src") ;; Rust source code PATH
...
I need to override the default keybinds to the ones I am more used too.
#+begin_src emacs-lisp :tangle yes
     (require 'cargo)
     (cargo-minor-mode)
))
