...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (window-number js2-mode popup epl pkg-info async helm-core helm grails-mode go-eldoc dash company flycheck eldoc rjsx-mode sass-mode go-mode company-go rust-mode cargo flycheck-rust racer company-racer org-ac))))
(custom-set-faces
